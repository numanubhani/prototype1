    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-display font-black text-white uppercase italic tracking-tighter mb-2">Join the <span className="text-primary italic">Fleet</span></h1>
          <p className="text-white/30 font-medium uppercase tracking-widest text-[10px]">Create your futuristic delivery profile</p>
        </div>

        <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/5 p-10 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-white/40 tracking-[0.2em] ml-4">Full Name</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-white/40 tracking-[0.2em] ml-4">Password</label>
              <div className="relative">
