    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-display font-black text-app-text uppercase italic tracking-tighter mb-2">Welcome <span className="text-primary italic">Back</span></h1>
          <p className="text-app-text/30 font-medium uppercase tracking-widest text-[10px]">Access the future of delivery in Oman</p>
        </div>
        ...
        <div className="bg-app-card backdrop-blur-xl rounded-[20px] border border-app-border p-10 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between px-4">
                <label className="text-[10px] font-black uppercase text-app-text/40 tracking-[0.2em]">Password</label>
          ...
          <div className="mt-10 pt-10 border-t border-app-border">
            <button className="w-full bg-app-card hover:bg-app-card/80 border border-app-border p-5 rounded-[20px] flex items-center justify-center gap-3 transition-all text-app-text font-bold mb-6">
              <Github className="w-5 h-5" />
              Continue with Passport
            </button>
            
            <p className="text-center text-xs text-app-text/30">
