...
export default function Footer() {
  return (
    <footer className="bg-black/60 border-t border-white/5 backdrop-blur-md py-6 px-8 text-[11px] text-white/30 uppercase tracking-[0.2em] mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-4">
           <span className="text-white font-black italic">DRONE<span className="text-primary">EXPRESS</span> OMAN</span>
